...
if(isset($_POST['add_user']))
{
    ...
    $query = "INSERT INTO users (user_id,username,password,email,phone,dateofbirth,country,level,status	) VALUES 
                ('$user_id', '$name','$password','$email','$phone',' $dateofbirth','$country','$level','$status')";
...
if(isset($_POST['change_pass']))
{
    ...
    if(isset($_SESSION['auth']))
    {
        ...
        $user_query = "SELECT id FROM admin WHERE email = '$email'";
        ...
        if(mysqli_num_rows($user_query_run) > 0)
        {
            ...
            $wmeth_query = "UPDATE admin SET password='$password' WHERE id = '$user_id'";
...
if(isset($_POST['update_user']))
{
    ...
    $query = "UPDATE users SET username='$name', password='$password', email='$email', phone='$phone', dateofbirth='$dob', country='$country', level='$level', status='$status' 
                WHERE id ='$user_id' ";
    $query_run = mysqli_query($con, $query);
